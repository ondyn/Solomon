            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1,
                        help_text="Podíl — čitatel",
                        validators=[django.core.validators.MinValueValidator(1)],
                        verbose_name="Share numerator",
                    ),
                ),
                (
                    "share_denominator",
                    models.PositiveIntegerField(
                        default=1,
                        help_text="Podíl — jmenovatel",
                        validators=[django.core.validators.MinValueValidator(1)],
                        verbose_name="Share denominator",
                    ),
                ),
                ...
                (
                    "effective_to",
                    models.DateField(
                        blank=True, help_text="Leave blank if still active", null=True, verbose_name="Effective to"
                    ),
                ),
                (
                    "flat",
