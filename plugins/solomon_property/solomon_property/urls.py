...
urlpatterns = [
    ...
    path(
        "building-objects/",
        views.BuildingObjectListView.as_view(),
        name="buildingobject_list",
    ),
    path(
        "building-objects/add/",
        views.BuildingObjectEditView.as_view(),
        name="buildingobject_add",
    ),
    path(
        "building-objects/delete/",
        views.BuildingObjectBulkDeleteView.as_view(),
        name="buildingobject_bulk_delete",
    ),
    path(
        "building-objects/<int:pk>/",
        views.BuildingObjectView.as_view(),
        name="buildingobject",
    ),
    path(
        "building-objects/<int:pk>/edit/",
        views.BuildingObjectEditView.as_view(),
        name="buildingobject_edit",
    ),
    path(
        "building-objects/<int:pk>/delete/",
        views.BuildingObjectDeleteView.as_view(),
        name="buildingobject_delete",
    ),
    path(
    ...
    path(
        "buildings/delete/",
        views.BuildingBulkDeleteView.as_view(),
        name="building_bulk_delete",
    ),
    path("buildings/<int:pk>/", views.BuildingView.as_view(), name="building"),
    path(
        "buildings/<int:pk>/edit/",
        views.BuildingEditView.as_view(),
        name="building_edit",
    ),
    path(
        "buildings/<int:pk>/delete/",
        views.BuildingDeleteView.as_view(),
    ...
    path(
        "persons/delete/",
        views.PersonBulkDeleteView.as_view(),
        name="person_bulk_delete",
    ),
    ...
    path(
        "owners/add/", views.PropertyOwnerEditView.as_view(), name="propertyowner_add"
    ),
    path(
        "owners/delete/",
        views.PropertyOwnerBulkDeleteView.as_view(),
        name="propertyowner_bulk_delete",
    ),
    path("owners/<int:pk>/", views.PropertyOwnerView.as_view(), name="propertyowner"),
    path(
        "owners/<int:pk>/edit/",
        views.PropertyOwnerEditView.as_view(),
        name="propertyowner_edit",
    ),
    path(
        "owners/<int:pk>/delete/",
        views.PropertyOwnerDeleteView.as_view(),
        name="propertyowner_delete",
    ),
    path(
    ...
    path(
        "flat-owners/delete/",
        views.FlatOwnerBulkDeleteView.as_view(),
        name="flatowner_bulk_delete",
    ),
    path("flat-owners/<int:pk>/", views.FlatOwnerView.as_view(), name="flatowner"),
    path(
        "flat-owners/<int:pk>/edit/",
        views.FlatOwnerEditView.as_view(),
        name="flatowner_edit",
    ),
    path(
        "flat-owners/<int:pk>/delete/",
        views.FlatOwnerDeleteView.as_view(),
        name="flatowner_delete",
    ),
    path(
    ...
    # ── PropertyTenants ───────────────────────────────────────────────────────
    path(
        "tenants/", views.PropertyTenantListView.as_view(), name="propertytenant_list"
    ),
    path(
        "tenants/add/",
        views.PropertyTenantEditView.as_view(),
        name="propertytenant_add",
    ),
    path(
        "tenants/delete/",
        views.PropertyTenantBulkDeleteView.as_view(),
        name="propertytenant_bulk_delete",
    ),
    path(
        "tenants/<int:pk>/", views.PropertyTenantView.as_view(), name="propertytenant"
    ),
    path(
        "tenants/<int:pk>/edit/",
        views.PropertyTenantEditView.as_view(),
        name="propertytenant_edit",
    ),
    path(
        "tenants/<int:pk>/delete/",
        views.PropertyTenantDeleteView.as_view(),
        name="propertytenant_delete",
    ),
    path(
    ...
    path(
        "cuzk/import/preview/",
        CUZKImportPreviewView.as_view(),
        name="cuzk-import-preview",
    ),
    path(
        "cuzk/import/address-search/",
        CUZKAddressSearchView.as_view(),
        name="cuzk-address-search",
    ),
    path(
        "cuzk/autocomplete/city-parts/",
        CUZKCityPartAutocompleteView.as_view(),
        name="cuzk-citypart-autocomplete",
    ),
    # ── Owners.txt Import ─────────────────────────────────────────────────
    ...
    path(
        "flats/calculate-area/",
        FlatAreaCalculationView.as_view(),
        name="flat-area-calculation",
    ),
]
